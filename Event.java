...
public class Event implements Comparable<Event> {
	 ...
	 * @param startTime stores the date of event and the startTime
	 * @param endTime stores end time of event
	 */
	...
	/**
	 * 
	 * @param e - the event to check if two events are the same or not
